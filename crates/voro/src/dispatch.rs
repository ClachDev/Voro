...
//! guarding that the checkout is a git repository, writing the prompt, and
//! spawning the process detached — kept out of voro-core, which stays pure of process and
